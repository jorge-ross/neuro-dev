...
const IntroSection = () => {
  ...
  return (
    <SectionContainer>
      <SectionTitle>Psicología y Neuropsicología clínica.</SectionTitle>
      <Description>
        Comienza hoy tu viaje hacia una vida más saludable y significativa con Neuro-dev. Servicios profesionales adaptados a tus necesidades.
      </Description>
